...
ALTER TABLE PRODUCTS DROP CONSTRAINT SUPPLIERS_ID_FK;
ALTER TABLE SUPPLIERS DROP CONSTRAINT SUPPLIERS_ID_PK;
ALTER TABLE SUPPLIERS ADD CONSTRAINT PHONE_FK PRIMARY KEY (PHONE);

--Добавляет в таблицу Customers колонку IS_ACTIVE, которая должна принимать одно из двух значений - 0 или 1 и не быть пустой
ALTER TABLE CUSTOMERS ADD IS_ACTIVE NUMBER(1) CHECK (IS_ACTIVE IN(0,1)) NOT NULL;

--Обновите длину поля Picture в таблице Categories до 100 символов
ALTER TABLE CATEGORIES MODIFY PICTURE NVARCHAR2(100);